...
namespace Tracman.Tenrox.Integration.TenroxLogonService {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Tracman.Tenrox.Integration.TenroxLogonService.LogonFaultContract))]
    ...
    [System.SerializableAttribute()]
    public partial class LogonFaultContract : Tracman.Tenrox.Integration.TenroxLogonService.TenroxFaultContract {
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="Tenrox.Server.Framework.Business.ServiceContracts", ConfigurationName="TenroxLogonService.ILogonAs")]
    public interface ILogonAs {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Tracman.Tenrox.Integration.TenroxLogonService.LogonFaultContract), Action="Tenrox.Server.Framework.Business.ServiceContracts/ILogonAs/AuthenticateLogonFault" +
            "ContractFault", Name="LogonFaultContract", Namespace="http://Tenrox.Server.Framework.WebServices.FaultContracts")]
        UserToken Authenticate(string p_strOrgName, string p_strUserName, string p_strPassword, string p_strIPAddress, bool p_boolForceTenrox);
        
        [System.ServiceModel.OperationContractAttribute(Action="Authenticate", ReplyAction="Tenrox.Server.Framework.Business.ServiceContracts/ILogonAs/AuthenticateResponse")]
        System.Threading.Tasks.Task<UserToken> AuthenticateAsync(string p_strOrgName, string p_strUserName, string p_strPassword, string p_strIPAddress, bool p_boolForceTenrox);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="ReinitializeToken", ReplyAction="Tenrox.Server.Framework.Business.ServiceContracts/ILogonAs/ReinitializeTokenRespo" +
            "nse")]
        bool ReinitializeToken(UserToken p_userToken);
        
        [System.ServiceModel.OperationContractAttribute(Action="ReinitializeToken", ReplyAction="Tenrox.Server.Framework.Business.ServiceContracts/ILogonAs/ReinitializeTokenRespo" +
            "nse")]
        System.Threading.Tasks.Task<bool> ReinitializeTokenAsync(UserToken p_userToken);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ILogonAsChannel : Tracman.Tenrox.Integration.TenroxLogonService.ILogonAs, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LogonAsClient : System.ServiceModel.ClientBase<Tracman.Tenrox.Integration.TenroxLogonService.ILogonAs>, Tracman.Tenrox.Integration.TenroxLogonService.ILogonAs {
        ...
        public UserToken Authenticate(string p_strOrgName, string p_strUserName, string p_strPassword, string p_strIPAddress, bool p_boolForceTenrox) {
            return base.Channel.Authenticate(p_strOrgName, p_strUserName, p_strPassword, p_strIPAddress, p_boolForceTenrox);
        }
        
        public System.Threading.Tasks.Task<UserToken> AuthenticateAsync(string p_strOrgName, string p_strUserName, string p_strPassword, string p_strIPAddress, bool p_boolForceTenrox) {
        ...
        public bool ReinitializeToken(UserToken p_userToken) {
            return base.Channel.ReinitializeToken(p_userToken);
        }
        
        public System.Threading.Tasks.Task<bool> ReinitializeTokenAsync(UserToken p_userToken) {
